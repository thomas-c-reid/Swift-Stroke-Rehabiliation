...
#line hidden
        ...
        public GetUserFeature(GetUserFeature.FixtureData fixtureData, SwiftUserManagement_Application_Tests_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
